...
public class LoginActivity extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        login_field = (EditText) findViewById(R.id.loginInput);
        pass_field = (EditText) findViewById(R.id.passwordInput);
   ...
   public static EditText login_field;
   public static EditText pass_field;
}
